...
class ParserUtilsTest {
	...
	@Test
	void testNormalizeSimpleNumbers() {
	...
	@Test
	void testNormalizeScaleNumbers() {
	...
	@Test
	void testNormalizeCombinedNumbers() {
	...
	void testStripQuotes() {
		assertEquals("foo bar", ParserUtils.stripQuotes("'foo bar'"));
		assertEquals("foo bar", ParserUtils.stripQuotes("\"foo 'bar'\""));
		assertEquals("foo bar", ParserUtils.stripQuotes("\"'\'foo\''\" \"bar\""));
	}
